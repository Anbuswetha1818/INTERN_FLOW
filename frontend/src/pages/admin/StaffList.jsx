    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      <Box className="glass-card" sx={{ p: 3 }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3, flexWrap: 'wrap', gap: 2 }}>
          <Box sx={{ display: 'flex', gap: 1.5, flexWrap: 'nowrap', flex: 1, overflowX: 'auto', pb: 0.5 }}>
            <TextField
              size="small"
          ...
          {canEdit && (
            <Box sx={{ display: 'flex', gap: 1, flexWrap: 'nowrap' }}>
              ...
              <CSVLink data={filteredStaff} filename="staff_list.csv" style={{ textDecoration: 'none' }}>
                <Button size="small" variant="outlined" startIcon={<Download fontSize="small" />} sx={{ whiteSpace: 'nowrap' }}>Export CSV</Button>
              </CSVLink>
              <Button size="small" variant="contained" startIcon={<Add fontSize="small" />} onClick={handleOpenAdd} sx={{ background: 'var(--gradient-primary)', whiteSpace: 'nowrap' }}>Add Staff</Button>
            </Box>
          )}
        </Box>
