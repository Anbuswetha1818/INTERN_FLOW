    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      {loading ? (
        ...
        >
          ...
          {/* AI Narrative Report */}
          {report.report && (
            <Paper className="glass-card" elevation={0} sx={{ p: 3, gridColumn: { xs: 'span 1', md: 'span 3' } }}>
              ...
              >
                ...
                {report.report.recommended_actions_for_intern?.length > 0 && (
                  <Accordion elevation={0} sx={{ border: '1px solid', borderColor: 'primary.light', borderRadius: '12px !important', gridColumn: { xs: 'span 1', md: 'span 2' } }}>
                    <AccordionSummary expandIcon={<ExpandMore />}>
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
